...
// JS is single-threaded synchronous programming language, so synchronous code goes directly to callstack and gets executed one by one
// and can handle asynchronous operations using the event loop

// The runtime consists of:
// 1. Call Stack - where function calls are made - usually function call tracking happens
// 2. Web APIs - provided by the environment (like setTimeout, DOM events)
// 3. Callback Queue - where callbacks from async operations wait
// 4. Event Loop - checks call stack and callback queue to manage execution
...
obj.method(); // "MyObject"
obj.arrowMethod(); // Not the object!
...
// E.Promise 3
// F.Timeout 1
// G.Promise in Timeout 1
// H.Timeout in Promise 1
// I.Timeout 2
